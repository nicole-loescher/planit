...
const Footer = () => {
    return (
        <div>
            <div style={{display:'flex', flexDirection: 'column', alignItems: 'center', color: 'white', backgroundColor: 'rgb(13, 13, 57)'}}>
                <p style={{ color: 'white', margin: '2px 0rem 1px 0rem'}}>Created by:</p>
                <p style={{ color: 'white', margin: '0rem 0rem 2px 0rem' }}>Nicole Loescher</p>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', backgroundColor: 'rgb(13, 13, 57)'}}>
